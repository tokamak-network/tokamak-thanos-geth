...
const (
	...
	Bn256PairingMaxInputSizeFjord    uint64 = 112687 // Maximum input size for an elliptic curve pairing check
	...
	BlobBaseCost                       = 1 << 13 // Base execution gas cost for a blob (EIP-7918).
